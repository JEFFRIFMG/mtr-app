    ...
    <div className="aw-wrap">
      ...
      <section className="aw-hero">
        ...
        <div className="aw-hero-visual">
          <img className="aw-trophy-img" src="https://ibouiklqlhfbzypecbqm.supabase.co/storage/v1/object/public/assets/mtr-hero-banner-latest.png" alt="MTR Broker Awards 2026 Trophy"/>
        </div>
      </section>
